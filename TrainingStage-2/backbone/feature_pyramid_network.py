...
class IntermediateLayerGetter(nn.ModuleDict):
    ...
    def __init__(self, model, return_layers):
        ...
        # Iterate through the model submodules and store them in a dictionary.
        # Save only the structure of a particular layer and its predecessors, and discard any unused structures
