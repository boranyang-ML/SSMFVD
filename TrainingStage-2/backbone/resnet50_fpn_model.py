...
def resnet50_fpn_backbone(pretrain_path="",
    ...
    Args:
        pretrain_path: pretrained resnet50
        norm_layer: default is FrozenBatchNorm2d, can also use BatchNorm2d
                    (https://github.com/facebookresearch/maskrcnn-benchmark/issues/267)
        trainable_layers: specify which layers need to be trained
        returned_layers: specify which layers output need to be returned
        extra_blocks: extra layers added on top of the output feature layer
